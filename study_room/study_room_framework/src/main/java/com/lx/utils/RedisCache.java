...
//        return value;
        Point point = new Point(blongitude,blatitude);
        Point point2 = new Point(ulongitude,ulatitude);
        redisTemplate.opsForGeo().add("GET_DISTANCE", point,"geo");
        redisTemplate.opsForGeo().add("GET_DISTANCE", point2,"geo2");
        Distance distance = redisTemplate.opsForGeo().distance("GET_DISTANCE", "geo", "geo2");
